      ...
      {articles.map((article, index) => (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-0 right-0 max-h-[70vh] overflow-y-auto flex flex-col p-8 pr-24"
          >
            <div className="absolute top-[-120px] left-0 right-0 px-8">
              <h1 className="text-4xl font-bold">{article.title}</h1>
            </div>
            <div className="flex items-center space-x-2 text-sm text-gray-300 mb-4 mt-4">
