...
const RightSidebar = ({ article }) => {
  ...
  const SidebarContent = () => (
    <div className="h-full flex flex-col justify-center pt-32 pointer-events-auto">
  ...
  return (
    <div className={`fixed right-0 top-0 bottom-0 md:w-[350px] sm:w-16 ${showChat ? 'bg-wikitok-dark border-l border-border p-4 z-50 sm:w-full' : 'bg-transparent'} pointer-events-none`}>
